...
use crate::{
    ...
    core_struct_info::{CoreStructInfo, get_core_struct_info},
    error::{ResolveError, ResolveErrorKind},
    initialized::Initialized,
    type_ctx::ResolveTypeOptions,
};
use asg::{
    IntoPolyRecipeResolver, PolyCatalog, PolymorphError, StructLiteral, StructRef, TypedExpr,
};
use ast::{ConformBehavior, FieldInitializer, FillBehavior};
...
fn get_field_info<'a>(
    ...
    let ty = catalog.resolver().resolve_type(&field.ty)?;
