use super::{PreferredType, ResolveExprCtx, ResolveExprMode, call::call_callee, resolve_expr};
use crate::{
    conform::{ConformMode, Perform, Validate, conform_expr, to_default::conform_expr_to_default},
...
pub fn resolve_static_member_call_polymorph(
    ...
    let return_type = recipe.resolver().resolve_type(&trait_func.return_type)?;
