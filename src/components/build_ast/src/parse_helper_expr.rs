...
impl<'a, I: InfinitePeekable<Token>> Parser<'a, I> {
    pub fn parse_helper_expr(
        ...
        let name = self.parse_identifier("for define name after 'define' keyword")?;
        self.ignore_newlines();

        self.input
            .expect(TokenKind::Assign, "after name of define")?;
        ...
        for annotation in annotations {
            match annotation.kind {
                ...
                _ => return Err(self.unexpected_annotation(&annotation, "for define")),
            }
        }
