    ...
    S: Copy,
{
    ...
    fn feed_idle_char(&mut self, c: char, source: S) -> FeedResult<Token<S>> {
        use FeedResult::*;
    ...
    fn feed_identifier(&mut self) -> FeedResult<Token<S>> {
        use FeedResult::*;
    ...
    fn feed_compound_identifier(&mut self) -> FeedResult<Token<S>> {
    ...
    fn feed_polymorph(&mut self) -> FeedResult<Token<S>> {
        use FeedResult::*;
    ...
    fn feed_macro(&mut self) -> FeedResult<Token<S>> {
        use FeedResult::*;
    ...
    fn feed_string(&mut self) -> FeedResult<Token<S>> {
        use FeedResult::*;
    ...
    fn feed_number(&mut self) -> FeedResult<Token<S>> {
        use FeedResult::*;
    ...
    fn feed_hex_number(&mut self) -> FeedResult<Token<S>> {
        use FeedResult::*;
    ...
    fn feed_short_generic(&mut self) -> FeedResult<Token<S>> {
        self.state = State::Idle;
...
impl<I, S> InfiniteIterator for Lexer<I, S>
where
    I: Text<S> + Send,
    S: Copy,
{
