    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        let kind = match kind {
            PreTokenKind::Identifier(name) => match name.as_str() {
                "alignas" => CTokenKind::AlignasKeyword,
                "alignof" => CTokenKind::AlignofKeyword,
                "auto" => CTokenKind::AutoKeyword,
                "bool" => CTokenKind::BoolKeyword,
                ...
                "static_assert" => CTokenKind::StaticAssertKeyword,
                "struct" => CTokenKind::StructKeyword,
                "switch" => CTokenKind::SwitchKeyword,
                "thread_local" => CTokenKind::ThreadLocalKeyword,
