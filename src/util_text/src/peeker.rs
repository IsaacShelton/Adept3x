use crate::{Character, Lexable};
use std::collections::VecDeque;
use util_infinite_iterator::InfiniteIterator;

pub struct Peeker<I, S: Copy>
where
...
impl<I, S> InfiniteIterator for Peeker<I, S>
where
    I: InfiniteIterator<Item = Character<S>>,
    S: Copy,
{
...
impl<I, S> Lexable<S> for Peeker<I, S>
where
    I: InfiniteIterator<Item = Character<S>>,
    S: Copy,
{
